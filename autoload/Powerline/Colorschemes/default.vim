...
let g:Powerline#Colorschemes#default#colorscheme = Pl#Colorscheme#Init([
	...
	\ Pl#Hi#Segments(['gundo:SPLIT', 'command_t:SPLIT'], {
		...
		\ }),
	\
	\ Pl#Hi#Segments(['lustyexplorer:static_str.name', 'minibufexplorer:static_str.name', 'nerdtree:raw.name', 'tagbar:static_str.name', 'bufferlist:static_str.name'], {
	...
	\ Pl#Hi#Segments(['lustyexplorer:static_str.buffer', 'tagbar:static_str.buffer'], {
		...
		\ }),
	\
	\ Pl#Hi#Segments(['lustyexplorer:SPLIT', 'minibufexplorer:SPLIT', 'nerdtree:SPLIT', 'tagbar:SPLIT', 'bufferlist:SPLIT'], {
		\ 'n': ['white', 'darkgreen'],
